...
export default function AdminReportsPage() {
  ...
  // Only psychologists and admins can access this page
  if (user.role !== 'PSYCHOLOGIST' && user.role !== 'ADMIN') {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Access Denied</h1>
          <p className="text-gray-600">Only psychologists and administrators can access this page.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Review and manage reports submitted by children. Update their status as you process them.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="text-sm text-gray-500">
              {user.role === 'ADMIN' ? 'Administrator View' : 'Psychologist View'}
            </div>
          </div>
